...
app.get('/team_stats', function(req, res) {
	var fball = req.query.football_db;
...
app.get('/player_info/select_player', function(req, res) {
        var fball = req.query.football_db;
        var idAndName = 'select * from football_games;';
        var playerInfo = 'select name from football_players where id=player_id;';
        var numGames = 'select count(players) from football_games where (select id from football_players wehre if=(player_id)=ANY(players);';
        db.task('get-everything', task => {
        return task.batch([
            task.any(idAndName),
            task.any(playerInfo),
